              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <svg
                        ...
                        <g opacity="0.5">
                          <path
                            d="M6.654 10.331c1.58 3.192 4.092 5.717 7.294 7.31l2.425-2.44a1.257 1.257 0 0 1 1.316-.29 9.687 9.687 0 0 0 3.076.511c.696 0 1.235.561 1.235 1.257V21.5c0 .696-.539 1.257-1.235 1.257C11.24 22.757 1.243 12.76 1.243 1.243 1.243.548 1.803 0 2.499 0h3.797c.696 0 1.257.548 1.257 1.243 0 1.073.182 2.089.511 3.08a1.29 1.29 0 0 1-.322 1.316l-2.44 2.44Z"
                            fill="" />
                        </g>
                      </svg>
                ...
                <div className="mt-6 text-left">
                  <p>
                    ...
                    <Link href="/frontend/login" className="text-dark">
                      Sign in
                    </Link>
                  </p>
                </div>
